...
public class ModFoods {
    ...
    public static final FoodProperties RAW_LIGHT_MEAT = (new FoodProperties.Builder()).nutrition(2).saturationMod(0.4F).effect(new MobEffectInstance(MobEffects.DIG_SLOWDOWN, 90, 0), 1F).effect(new MobEffectInstance(MobEffects.CONFUSION, 300, 5), 1F).effect(new MobEffectInstance(MobEffects.POISON, 1000, 3), 1F).meat().build();
    ...
    public static final FoodProperties STRANGE_MEAT = (new FoodProperties.Builder()).nutrition(2).saturationMod(0.4F).effect(new MobEffectInstance(MobEffects.DIG_SLOWDOWN, 90, 0), 1F).effect(new MobEffectInstance(MobEffects.CONFUSION, 300, 5), 1F).meat().build();
